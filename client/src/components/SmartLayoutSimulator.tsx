          ...
          <div className="mt-12 mb-8">
            <div className="mb-4">
              <h3 className="text-2xl font-bold text-foreground mb-2">
                {language === 'pt' ? '🤖 Visibilidade por IA' : '🤖 AI Visibility'}
              </h3>
              <p className="text-sm text-muted-foreground">
                {language === 'pt' 
                  ? 'Representação fiel da visualização da gôndola gerada por inteligência artificial com base nas recomendações de posicionamento.' 
                  : 'Faithful representation of the shelf visualization generated by artificial intelligence based on positioning recommendations.'}
              </p>
            </div>
